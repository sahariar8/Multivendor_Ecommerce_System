...
<!--============================
    FLASH SELL START
==============================-->
@include('frontend.section.flash-sell')
<!--============================
    FLASH SELL END
==============================-->
...
==============================-->
@include('frontend.section.monthly-top-product')
<!--============================
...
<!--============================
    BRAND SLIDER START
==============================-->
@include('frontend.section.brand-slider')
<!--============================
    BRAND SLIDER END
==============================-->
...
<!--============================
    SINGLE BANNER START
==============================-->
@include('frontend.section.single-banner')
<!--============================
    SINGLE BANNER END  
==============================-->
...
<!--============================
    HOT DEALS START
==============================-->
@include('frontend.section.hot-deals')
<!--============================
    HOT DEALS END  
==============================-->
...
==============================-->
@include('frontend.section.electronic')
<!--============================
    ELECTRONIC PART END  
==============================-->
...
<!--============================
    ELECTRONIC PART START  
==============================-->
@include('frontend.section.electronic2')
<!--============================
    ELECTRONIC PART END  
==============================-->
...
<!--============================
    LARGE BANNER  START  
==============================-->
@include('frontend.section.large-banner')
<!--============================
    LARGE BANNER  END  
==============================-->
...
==============================-->
@include('frontend.section.weekly-best-item')
<!--============================
...
<!--============================
  HOME SERVICES START
==============================-->
@include('frontend.section.home-services')
<!--============================
    HOME SERVICES END
==============================-->
...
<!--============================
    HOME BLOGS START
==============================-->
@include('frontend.section.home-blogs')
<!--============================
    HOME BLOGS END
==============================-->
@endsection